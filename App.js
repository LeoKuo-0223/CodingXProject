...
import { StyleSheet, View, Text, TextInput, Button, Alert, SafeAreaView, TouchableWithoutFeedback, Keyboard } from 'react-native';
import { Table, Row, Rows } from 'react-native-table-component';
import Header from './header';
import Home from './android/screen/Home';
import YearMode from './android/screen/MonthMode';
import MonthMode from './android/screen/YearMode';
import DateMode from './android/screen/DateMode';
